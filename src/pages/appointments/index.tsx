        ...
        {isLoading ? (
          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  {hasAccess('time_slot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>time_slot</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    {hasAccess('time_slot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/time-slots/view/${record.time_slot?.id}`}>
                          {record.time_slot?.status}
                        </Link>
                      </Td>
                    )}
